        ...
        <div class="card-body">
            <form action="{{ route('books.show', $book) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="publisher_year" type="text" class="form-control @error('publisher_year') is-invalid @enderror" name="publisher_year" value="{{ $book->publisher_year }}" autocomplete="publisher_year">
